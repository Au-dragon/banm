...
import com.example.banmi.activity.GoldActivity;
...
public class GoldAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public GoldAdapter(ArrayList<CardBean> list, Context context) {
        this.list = list;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        if(i == 0){
            View inflate = LayoutInflater.from(context).inflate(R.layout.gift_item_three, null);
            OneViewHolder oneViewHolder = new OneViewHolder(inflate);
            return oneViewHolder;
        }else {
            View inflate = LayoutInflater.from(context).inflate(R.layout.gift_item_four, null);
